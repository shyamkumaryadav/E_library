...
class Member(models.Model):
	...
	city = models.CharField(max_length=2, verbose_name='City', choices=citys)
	pincode = models.CharField(max_length=2, verbose_name='Pincode')
	address = models.CharField(max_length=2, verbose_name='Full Address')
	password = models.CharField(max_length=2, verbose_name='Password')
